...
//个性化弹幕框		
$(".alphaYplayer-comment-setting-color input").on("click", function() {
	var textcolor = $(this).attr("value");
	setTimeout(function() {
		$('.yzm-alphaYplayer-comment-input').css({
			"color": textcolor
		});
	}, 100);
});
$(".alphaYplayer-comment-setting-type input").on("click", function() {
	var texttype = $(this).attr("value");
	setTimeout(function() {
		$('.yzm-alphaYplayer-comment-input').attr("dmtype", texttype);
	}, 100);
});
$("#dmset").on("click", function() {
	$(".alphaYplayer-comment-icon").trigger("click");
	$(".alphaYplayer-comment-setting-box").toggleClass("alphaYplayer-comment-setting-open")
	$("#alphaYplayer").toggleClass("alphaYplayer-hide-controller")
});
...
$(".yzm-alphaYplayer-send-icon").on("click", function() {
	var inputtext = document.getElementById("dmtext");
	var sendtexts = inputtext.value;
	var sendtype = $('.yzm-alphaYplayer-comment-input').attr("dmtype");
	var sendcolor = $('.alphaYplayer-comment-input').css("color");
	...
	$(".yzm-alphaYplayer-comment-input").val("");
})
...
window.onload = function() {
	...
	$(".alphaYplayer-watching-number").text(usernum);
